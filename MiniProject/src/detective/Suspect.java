...
public class Suspect {
    ...
    public Suspect(int id, String name, int age, String occupation,
                   String relationshipWithVictim, String alibi,
                   int suspicionLevel) {
    ...
    public void displayDetails() {
        ...
        System.out.println("Relationship with victim: " + relationshipWithVictim);
        System.out.println("Alibi                   : " + alibi);
        System.out.println("Suspicion Level         : " + suspicionLevel + "/100");
    }
